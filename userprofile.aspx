                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class ="row">
                            ...
                            <center>
                                <div class ="form-group">
                                  <asp:Button ID="Button1" class="btn btn-primary btn-block btn-lg" runat="server" Text="Update"></asp:Button> 
                            </div>
                              </center>
                       </div>
                      </div>
                        ...
                        <div class ="row">
                            <div class ="col">
                                <center>
                                    ...
                                    <asp:Label Class="badge badge-pill badge-info" ID="Label2" runat="server" Text="Your Prescription Info"></asp:Label>
                                </center>
                             </div>
                            </div> 
