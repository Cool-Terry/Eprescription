<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DispensePrescription.aspx.cs" Inherits="WebApplication1.DispensePrescription" %>
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList4" runat="server">
                              <asp:ListItem Text="Paracetamol" Value="yes" />
                              <asp:ListItem Text="Morphine" Value="no" />
                           </asp:DropDownList>
                             </div>
                         </div>
                         </div>
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList6" runat="server">
                              <asp:ListItem Text="Strength 1 " Value="yes" />
                      ...
                      <div class="row">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList2" runat="server">
                              <asp:ListItem Text="Capsule" Value="Positive" />
                              <asp:ListItem Text="Syringe" Value="Negative" />
                           </asp:DropDownList>
                        </div>
                              </div> 
                     </div>
