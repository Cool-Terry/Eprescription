<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PharmacistRecords.aspx.cs" Inherits="WebApplication1.PharmacistRecords" %>
            ...
            <div class ="col-md-6 mt-xl-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class ="row">
                         ...
                         <div class="row">
                            <div class ="col">
                                ...
                                <div class ="form-group">
                                  <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="" TextMode="MultiLine" Rows="1"></asp:TextBox> 
                                 </div>
                             </div>
                         </div>
                         <div class="row">
                        ...
                        <div class ="col-md-6">
                                    <label>Pharmacist Qualification</label>
                                <div class ="form-group">
